...
class IntelligentBookAnalytics:
    ...
    print(f'done loading Word2Vec: {len(w2v_model.key_to_index.keys())}')
    ...
    def get_summary(self, full_text: str, max_length = 100) -> int:
...
if __name__ == "__main__":
    ...
    matching_title_index = myObj.find_matchingtitle(titles[0], titles[1:])
    print(f'\nMatching Title Index: {matching_title_index}')
    print(f'\nMatching Title: {titles[1:][matching_title_index]}')
    ...
    matching_title_index = myObj2.find_matchingtitle(titles[0], titles[1:])
    print(f'\nMatching Title Index: {matching_title_index}')
    print(f'\nMatching Title: {titles[1:][matching_title_index]}')
